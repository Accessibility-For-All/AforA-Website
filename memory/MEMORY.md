...
- [Deploy OIDC broken](deploy-oidc-broken.md) — MOOT since 2026-08-05: AWS pipeline superseded by Cloudflare Pages; never fix; soprisapps.com fate TBD
...
- [Hosting direction](hosting-direction.md) — ✅ LIVE on accessibilityforall.com via Cloudflare Pages (client acct); merge to main = prod deploy; Astro + scanner are future phases
...
- [⚠️ Tracking stack](tracking-stack.md) — GA4 hardcoded in <head>, Google Ads via navbarloader, GTM container empty; publishing GA4 in GTM without removing the inline gtag double-counts
